...
function openTeacherDialog(title){$('teacherDialogTitle').textContent=title;if(!$('teacherDialog').open)$('teacherDialog').showModal();requestAnimationFrame(()=>$('teacherName').focus())}
